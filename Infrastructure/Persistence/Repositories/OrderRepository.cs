...
namespace Infrastructure.Persistence.Repositories
{
    public class OrderRepository : IOrderRepository
    {
        ...
        public Task<Order?> GetById(Guid id, CancellationToken ct) => _db.Orders
            .Include(o => o.Items)
            .ThenInclude(oi => oi.Item)
            .FirstOrDefaultAsync(o => o.Id == id, ct);

        public Task<List<Order>> GetByUserIdAsync(Guid userId, CancellationToken ct) => _db.Orders
            .Include(o => o.Items)
            .ThenInclude(oi => oi.Item)
        ...
        public async Task DeleteAsync(Guid OrderId, CancellationToken ct) =>
            await _db.Orders.Where(x => x.Id == OrderId).ExecuteDeleteAsync(ct); 
